...
# addswitch(name)
topo.addswitch("sw1")
# user defined P4 code
topo.addp4("p4src/p7uav.p4")
...
# addlink(node1, node2, bw, pkt_loss, latency percentage, jitter variation, jitter percentage)
topo.addlink("h1","sw1", 10000000000, 0, 0, 0, 100)
topo.addlink("h2","sw1", 10000000000, 0, 5, 0, 100)

# addvlan_port(port,D_P,speed_bps,AU,FEC)
# Specific VLAN and port for skiiping into P7
...
# creating ASCII to HEX translator 
...
# ASII to HEX tables information
for i in range(1,5001):
	hexval = str(hex(i))
...
# collision table defining static objects and environemnt
...
# defining mirror packet generated from the P4 switch
