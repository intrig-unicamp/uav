...
topo.addlink("h3","sw5", 10000000000, 0, 0, 0, 100)
topo.addlink("h4","sw6", 10000000000, 0, 0, 0, 100)
topo.addlink("h5","sw7", 10000000000, 0, 0, 0, 100)

topo.addlink("sw1","sw2", 10000000000, 0, 0, 0, 100)
topo.addlink("sw1","sw4", 10000000000, 0, 0, 0, 100)
topo.addlink("sw2","sw3", 10000000000, 0, 0, 0, 100)
topo.addlink("sw2","sw5", 10000000000, 0, 0, 0, 100)
topo.addlink("sw3","sw7", 10000000000, 0, 0, 0, 100)
topo.addlink("sw3","sw6", 10000000000, 0, 0, 0, 100)
