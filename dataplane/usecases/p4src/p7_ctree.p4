...
const bit<16> total_sw = 10;         // total number of switches
        ...
        if (hdr.vlan_tag.isValid() && !hdr.rec.isValid() && !hdr.arp.isValid()) {
            ...
            if (hdr.rec.isValid()) {
		     ...
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 9){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 10){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 11){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 12){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 13){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 14){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
		     if(hdr.rec.signal==0){
                ...
                else if (hdr.rec.sw == 15){                   // 0 - ID switch
                    bit<8> value_tscal;
                    md.ts_diff = 0;
                    comp_diff();
    		     //apply the jitter
