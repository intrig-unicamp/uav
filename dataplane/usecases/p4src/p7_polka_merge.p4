...
control SwitchIngress(
    ...
    action send_next(bit<16> sw_id, bit<16> link_id) {
        // PolKa routing
    ...
    action send_next_2(bit<16> sw_id) {
        // PolKa routing
        md.ndata = (bit<112>) (hdr.rec.routeid >> 16);
        md.diff = (bit<16>) hdr.rec.routeid;
    ...
    action send_next_3(bit<16> sw_id) {
        // PolKa routing
        md.ndata = (bit<112>) (hdr.rec.routeid >> 16);
        md.diff = (bit<16>) hdr.rec.routeid;
    ...
    action send_next_4(bit<16> sw_id) {
        // PolKa routing
        md.ndata = (bit<112>) (hdr.rec.routeid >> 16);
        md.diff = (bit<16>) hdr.rec.routeid;
    ...
    action send_next_5(bit<16> sw_id) {
        // PolKa routing
        md.ndata = (bit<112>) (hdr.rec.routeid >> 16);
        md.diff = (bit<16>) hdr.rec.routeid;
