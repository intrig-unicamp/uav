...
topo.addhost("h3","1/3", 134, 10000000000, "False", "False", 1920, "192.168.100.3")
#topo.addhost("h4","1/4", 134, 10000000000, "False", "False", 1920, "192.168.100.4")
topo.addhost("h5","1/4", 134, 10000000000, "False", "False", 1920, "192.168.100.4")
#topo.addhost("h6","1/4", 134, 10000000000, "False", "False", 1920, "192.168.100.4")
topo.addhost("h7","1/4", 134, 10000000000, "False", "False", 1920, "192.168.100.4")
#topo.addhost("h8","1/4", 134, 10000000000, "False", "False", 1920, "192.168.100.4")

# addlink(node1, node2, bw, pkt_loss, latency, jitter, percentage)
# bw is considered just for the first defined link
topo.addlink("h1","sw7", 10000000000, 0, 0, 0, 100)
#topo.addlink("h2","sw7", 10000000000, 0, 0, 0, 100)
topo.addlink("h3","sw8", 10000000000, 0, 0, 0, 100)
#topo.addlink("h4","sw8", 10000000000, 0, 0, 0, 100)

topo.addlink("h5","sw9", 10000000000, 0, 0, 0, 100)
#topo.addlink("h6","sw9", 10000000000, 0, 0, 0, 100)
topo.addlink("h7","sw10", 10000000000, 0, 0, 0, 100)
#topo.addlink("h8","sw10", 10000000000, 0, 0, 0, 100)

topo.addlink("sw7","sw3", 10000000000, 0, 0, 0, 100)
topo.addlink("sw7","sw4", 10000000000, 0, 0, 0, 100)
topo.addlink("sw8","sw3", 10000000000, 0, 0, 0, 100)
topo.addlink("sw8","sw4", 10000000000, 0, 0, 0, 100)
topo.addlink("sw3","sw1", 10000000000, 0, 0, 0, 100)

topo.addlink("sw1","sw5", 10000000000, 0, 0, 0, 100)
topo.addlink("sw4","sw2", 10000000000, 0, 0, 0, 100)

topo.addlink("sw9","sw5", 10000000000, 0, 0, 0, 100)
topo.addlink("sw9","sw6", 10000000000, 0, 0, 0, 100)
topo.addlink("sw10","sw5", 10000000000, 0, 0, 0, 100)
topo.addlink("sw10","sw6", 10000000000, 0, 0, 0, 100)
topo.addlink("sw6","sw2", 10000000000, 0, 0, 0, 100)
